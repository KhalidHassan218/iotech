...
export interface ApiHerobannerHerobanner extends Struct.SingleTypeSchema {
  collectionName: 'herobanners';
  info: {
    displayName: 'herobanner';
    pluralName: 'herobanners';
    singularName: 'herobanner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::herobanner.herobanner'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slides: Schema.Attribute.Component<'herobanner.slide', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTeamServiceTeamService extends Struct.CollectionTypeSchema {
  collectionName: 'team_services';
  info: {
    displayName: 'Team Service';
    pluralName: 'team-services';
    singularName: 'team-service';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::herobanner.herobanner': ApiHerobannerHerobanner;
      'api::newsletter-subscription.newsletter-subscription': ApiNewsletterSubscriptionNewsletterSubscription;
      'api::team-service.team-service': ApiTeamServiceTeamService;
